...
def loop_through_people(frame, keypoints_with_scores, boxes, edges, confidence_threshold):
    ...
    #print("MAX AREA: ", maxArea, "MAX HEIGHT: ", maxPersonBoxHeight, "MAX WIDTH: ", maxPersonBoxWidth, )
    ...
    panStatus = maxAreaPersonBoxCenterX
    tiltStatus = maxAreaPersonBoxCenterY
    
    return maxAreaPersonBoxCenterX,maxAreaPersonBoxCenterY,count


locomotionStatus = 0
cap = cv2.VideoCapture("C:/Users/Asus.DESKTOP-1EO1OQ5/Desktop/7th Sem project/videoplayback.mp4")
while cap.isOpened():
    ret, frame = cap.read()
    img = frame.copy()
